...
\begin{figure}[htbp]
	\centering%
	\subfigure%
	{\includegraphics[height=10cm, width=10cm, keepaspectratio]{Immagini/Capitolo2/strong_auth_secret.png}}
...
\begin{figure}[htbp]
	\centering%
	\subfigure%
	{\includegraphics[height=9cm, width=10cm, keepaspectratio]{Immagini/Capitolo2/des_structure.png}}
