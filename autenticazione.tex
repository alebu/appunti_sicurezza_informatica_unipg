...
\section{Protocolli di autenticazione}
...
\subsection{Protocolli a sfida e risposta unidirezionali ("login only")}
...
\subsubsection{Protocolli a chiave pubblica}
...
\subsection{Protocolli a sfida e risposta, mutua autenticazione} \label{par:aut_prot_mut_aut}
...
\end{figure}
\paragraph{(P11*) Protocollo 11 con timestamp}
...
\paragraph{(P11**) Protocollo 11 con timestamp e principal flag}
...
\hline
      & TECNOLOGIA                                                             & VULNERABILITA'                                                                                                                                                                                                     & MESS. \\ \hline
P1    & chiave segreta/hash                                                    & \begin{tabular}[c]{@{}l@{}}non ho mutua autenticazione\\ \\ attacco dictionary senza intercettazione \\ (sfida in chiaro)\\ \\ vulnerabile ad attacchi passivi sul server\end{tabular}                             & 3     \\ \hline
P2    & chiave segreta                                                         & \begin{tabular}[c]{@{}l@{}}attacco dictionary senza intercettazione \\ se la sfida è riconoscibile\\ \\ vulnerabile ad attacchi passivi sul server\end{tabular}                                                    & 3     \\ \hline
P3    & chiave segreta/hash                                                    & \begin{tabular}[c]{@{}l@{}}non ho mutua autenticazione\\ riutilizzo veloce del messaggio\\ sicurezza dipendente dall'ora\\ costoso se utilizzato con hash\\ vulnerabile a attacchi passivi sul server\end{tabular} & 1     \\ \hline
P4    & hash                                                                   & \begin{tabular}[c]{@{}l@{}}non ho mutua autenticazione\\ riutilizzo veloce del messaggio\end{tabular}                                                                                                              & 1     \\ \hline
P5    & \begin{tabular}[c]{@{}l@{}}chiave pubblica\\ (firma)\end{tabular}      & \begin{tabular}[c]{@{}l@{}}non ho mutua autenticazione\\ vulnerabili a attacchi attivi sul server\end{tabular}                                                                                                     & 3     \\ \hline
P6    & \begin{tabular}[c]{@{}l@{}}chiave pubblica \\ (cifratura)\end{tabular} & \begin{tabular}[c]{@{}l@{}}non ho mutua autenticazione\\ \\ molti protocolli a chiave pubblica\\ permettono solo la firma\end{tabular}                                                                             & 3     \\ \hline
P7    & chiave segreta/hash                                                    &                                                                                                                                                                                                                    & 5     \\ \hline
P8    & chiave segreta/hash                                                    & \begin{tabular}[c]{@{}l@{}}reflection\\ \\ attacco dictionary senza intercettazione \\ (sfida in chiaro)\end{tabular}                                                                                              & 3     \\ \hline
P9    & chiave segreta/hash                                                    & DOS verso il client (meno rilevante)                                                                                                                                                                               & 4     \\ \hline
P10   & \begin{tabular}[c]{@{}l@{}}chiave pubblica \\ (cifratura)\end{tabular} & \begin{tabular}[c]{@{}l@{}}molti protocolli a chiave pubblica \\ permettono solo la firma\end{tabular}                                                                                                             & 3     \\ \hline
P11   & \begin{tabular}[c]{@{}l@{}}chiave pubblica\\  (firma)\end{tabular}     &                                                                                                                                                                                                                    & 3     \\ \hline
P11*  & chiave segreta/hash                                                    & riutilizzo veloce del messaggio                                                                                                                                                                                    & 2     \\ \hline
P11** & \begin{tabular}[c]{@{}l@{}}chiave pubblica \\ (cifratura)\end{tabular} &                                                                                                                                                                                                                    & 2     \\ \hline
\end{tabular}
\end{table}
\section{Cifratura e integrità dei dati}
...
Una possibile chiave di sessione è infatti:
\begin{equation}
...
\subsection{Chiave di sessione nell'autenticazione a chiave pubblica}
\paragraph{(1) \textit{K\ped{S} = R} - Alice invia \textit{{R}\ped{Bob}}}
\label{subsec:caso1}
...
\paragraph{(2) \textit{K\ped{S}} = R - Alice invia \textit{[\{R\}\ped{Bob}]\ped{Alice}}}
...
\paragraph{(3) \textit{K\ped{S} = R $\oplus$ P}  - R e P non vengono inviate in chiaro}
...
\subsection{Chiave di sessione nell'autenticazione unidirezionale}
...
\paragraph{(a) \textit{K\ped{s}} = R e Alice invia \textit{\{R\}\ped{Bob}}} (\figurename~\ref{fig:ImgS81bis}): 
\begin{figure}[htbp]
	\centering%
	\subfigure%
...
\subsection{Garantire confidenzialità e integrità}
...
\subsection{Distribuzione delle chiavi segrete - KDC}
...
\paragraph{(P12) Protocollo 12 - Mediazione del KDC}
...
\paragraph{KDC: vantaggi e svantaggi}
