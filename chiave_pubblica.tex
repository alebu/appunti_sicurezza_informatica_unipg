...
m < n \implies |m|<|n|
\end{equation}
Dove |m| è la lunghezza in bit del messaggio da processare. Per poter processare quindi messaggi di lunghezza qualsiasi non posso utilizzare solo RSA.
...
\begin{figure}[htbp]
	...
	\caption{}
\end{figure}
\subsection{Requisiti prova a conoscenza zero}
\begin{itemize}
