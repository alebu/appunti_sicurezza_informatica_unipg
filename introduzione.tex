...
\begin{itemize} 
  ...
  \item \textbf{Principio fondamentale della crittografia (Fundamental tenet of cryptography)}: If lots ofsmart people have failed to solve a problem, then it probably won’t be solved (soon)
\end{itemize}
