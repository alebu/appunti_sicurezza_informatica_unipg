...
L'obiettivo è quello di stimare il numero di coppie candidate dopo il test i-esimo $cc_i$. Definendo $c_{tot}$ come il numero delle coppie totali iniziali, tale valore è dato dalla seguente espressione:
\[
